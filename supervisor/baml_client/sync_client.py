...
class BamlSyncClient:
    ...
    def AnalyzeVerifierOutput(self, command: str,exit_code: int,stdout: str,stderr: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="AnalyzeVerifierOutput", args={
...
class BamlStreamClient:
    ...
    def AnalyzeVerifierOutput(self, command: str,exit_code: int,stdout: str,stderr: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.VerifierOutcome, types.VerifierOutcome]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="AnalyzeVerifierOutput", args={
            "command": command,"exit_code": exit_code,"stdout": stdout,"stderr": stderr,
        })
        return baml_py.BamlSyncStream[stream_types.VerifierOutcome, types.VerifierOutcome](
          __result__,
