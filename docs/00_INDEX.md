...
- docs/specs/CHOIR_WORK_QUEUE_SPEC.md (DRAFT)
- docs/specs/CHOIR_AUDITOR_MULTIPASS_SPEC.md (DRAFT)
- docs/specs/CHOIR_VISUALIZATION_GRAPH_SPEC.md (DRAFT)
- docs/specs/CHOIR_AGENTFS_INTEGRATION_SPEC.md (DRAFT)
...
- docs/specs/VERIFICATION_GREEN_THREADS_SPEC.md
