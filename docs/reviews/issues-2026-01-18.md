...
## In Progress
- [ ] BAML Phase 1 | Verifier Walking Skeleton: `VerifierRunner` now uses BAML for structured analysis. Spec: `docs/grand_strategy_update-jan_18.md` & `baml_research_and_design.md`.
