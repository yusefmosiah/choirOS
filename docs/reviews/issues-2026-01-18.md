...
- [x] BAML Phase 1 | Verifier Walking Skeleton: `VerifierRunner` now uses BAML for structured analysis. Spec: `docs/grand_strategy_update-jan_18.md` & `baml_research_and_design.md`.

## In Progress
- [ ] BAML Phase 2 | Tooling & Agents: Structured tool calling definitions and BAML-based tool execution.
- [ ] BAML Phase 3 | The Director: Orchestration logic and "State of World" analysis using BAML.
