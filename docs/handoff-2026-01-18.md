...
- Target branch: `main`
- Current branch renamed to: `yusefmosiah/progress-handoff`
...
- sprites.dev selected for sandboxing; CLI install + smoke test completed.
...
- sprites.dev CLI: install per https://sprites.dev/install.sh using the org token; create sprite and verify exec before wiring adapter.
